...
public:
    int minCost(vector<int>& houses, vector<vector<int>>& cost, int m, int n, int target) {
        vector<vector<vector<int>>> dp(m+1,vector<vector<int>>(101,vector<int>(n+1,-2)));
        return fun(houses,dp,cost,target,0,0);
    }
